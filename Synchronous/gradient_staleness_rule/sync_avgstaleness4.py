...
pull_updates_interval = 9  # pull updates every 9 intervals ->
                           # average staleness = (9 - 1) / 2 = 4.
...
for i in range(iterations):
    ...
    pulled_weights = ps.apply_gradients.remote(*gradients)
    if i % pull_updates_interval == 0:
